            ...
            <div class="col-sm-2">
                <form action="" method="post">
                    <select name="" id="" class="form-group">
                        ...
                        <?php foreach($listTrangThaiDonHang as $key=>$trang_thai):?>
                        <option  
      ...
      <div class="container-fluid">
        <div class="row">
            ...
            if ($donHang['trang_thai_id'] = 1) {
                $coloAlerts = 'primary';
            }elseif($donHang['trang-thai-id'] >=2 && $donHang['trang_thai_id'] <=9){
                $coloAlerts = 'warning';
            ...
            <div class="invoice p-3 mb-3">
              ...
              <div class="row">
                <div class="col-12">
                  <h4>
                    <i class="fas fa-tshirt"></i> Shop quần áo Anhldph
