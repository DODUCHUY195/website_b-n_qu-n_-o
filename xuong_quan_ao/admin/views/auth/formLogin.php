...
<head>
    ...
    <script data-cfasync="false" nonce="ecb9c6be-dcaf-45be-9c43-a8559b94a8fc">
        try {
            (function(w, d) {
                ! function(fv, fw, fx, fy) {
                    if (fv.zaraz) console.error("zaraz is loaded twice");
                        ...
                        fv.zaraz._v = "5858";
                        fv.zaraz._n = "ecb9c6be-dcaf-45be-9c43-a8559b94a8fc";
                        fv.zaraz.q = [];
                        ...
                        fv.zaraz.init = () => {
                            ...
                            fD.defer = !0;
                            for (const fJ of [localStorage, sessionStorage]) Object.keys(fJ || {}).filter((fL => fL.startsWith("_zaraz_"))).forEach((fK => {
                                try {
    ...
    <div class="login-box">
        ...
        <div class="card card-outline card-primary">
            <div class="card-header text-center">
                <a href="./assets/index2.html" class="h1"><b>Bán quần áo</b></a>
            </div>
            <div class="card-body">
